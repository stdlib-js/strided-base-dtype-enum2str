...
```javascript
enum2str = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-enum2str@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-enum2str@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-str2enum@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-enum2str@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
...
[test-image]: https://github.com/stdlib-js/strided-base-dtype-enum2str/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/strided-base-dtype-enum2str/actions/workflows/test.yml?query=branch:main
